        ...
        <div class="container px-5 lg:px-0 pb-[50px]">
            <section class="text-start  pb-[50px]">
                ...
                <div class="flex justify-around items-center my-10 flex-col gap-[24px] lg:gap-[0] lg:flex-row">
                    {firstSection?.cards?.map((item, index) => (
                        <div key={index} class="flex flex-row lg:flex-col space-between items-center max-w-[340px] w-full">
                            ...
                            <p dangerouslySetInnerHTML={{ __html: item?.label || '' }} class="mt-4 text-sm text-center"></p>
                        </div>
                    ))}
                </div>
            </section>
            ...
            <section class="text-start mb-12">
                ...
                <div class="relative flex justify-between items-center lg:max-w-[686px] w-full mx-auto">
                    <div class="absolute top-[22px] left-0 right-0 h-[20px] bg-white rounded-full"></div>
                ...
                <div class="flex justify-around lg:px-[85px]">
                    <div class="mt-8 text-sm text-end flex gap-[20px] flex-col">
                        ...
                        <p class="text-black text-[28px] leading-[30px]">Faça seu cadastro</p>
                    </div>
                    <div class="mt-8 text-sm text-center flex gap-[20px] flex-col">
                        <p class="text-primary font-bold text-[32px]">02.</p>
                        <p class="text-black text-[28px] leading-[30px]">Assine o contrato</p>
                    </div>
                    <div class="mt-8 text-sm text-start flex gap-[20px] flex-col">
                        <p class="text-primary font-bold text-[32px]">03.</p>
                        <p class="text-black text-[28px] leading-[30px]">Conecte seus produtos</p>
                    </div>
                </div>
            </section>

            <section class="text-start">
                <h2 dangerouslySetInnerHTML={{ __html: secondSection?.title || '' }} class="text-3xl font-bold text-black mb-6"></h2>
                <a dangerouslySetInnerHTML={{ __html: secondSection?.button?.label || '' }} href={secondSection?.button?.link} class="bg-black text-white text-xl font-bold py-4 px-5 mb-8 inline-block w-full rounded-[30px] text-center">
                </a>
            </section>

            <section dangerouslySetInnerHTML={{ __html: secondSection?.html || '' }} class="text-left">
