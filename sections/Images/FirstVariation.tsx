        ...
        <>
            {device === "desktop" && (
                <div class="container">
                    ...
                    {bannerFull &&
                        <div>
                            <a href={bannerFull.Link} class="flex justify-center" key="bannerFull">
                                <Image
                                    src={bannerFull.desktop?.Image ? bannerFull.desktop?.Image : `https://placehold.co/${bannerFull.desktop?.Width}x${bannerFull.desktop?.Height}`}
                                    alt={bannerFull.Alt || 'esse é um banner de uma marca tradicional'}
            ...
            {device === "mobile" && (
                <div>
                    <div class="my-[35px]">
                        {title && <p class="text-base sm:text-3xl font-semibold">{title}</p>}
                    </div>
                    <div class="my-6">
                        <a href={items[0].Link} class="flex">
                            <Image
                                src={items[0].mobile?.Image ? items[0].mobile?.Image : `https://placehold.co/${items[0].mobile?.Width}x${items[0].mobile?.Height}`}
                                alt={items[0].Alt || 'esse é um banner de uma marca tradicional'}
                    ...
                    <div class="my-6">
                        <a href={bannerFull?.Link} class="flex">
                            <Image
                                src={bannerFull?.mobile?.Image ? bannerFull?.mobile?.Image : `https://placehold.co/${bannerFull?.mobile?.Width}x${bannerFull?.mobile?.Height}`}
                                alt={bannerFull?.Alt || 'esse é um banner de uma marca tradicional'}
