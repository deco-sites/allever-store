                  ...
                  <div class="grid grid-cols-12 gap-4">
                    <a href={items[0]?.Link} class="col-span-8">
                      <Image src={items[0].desktop?.Image
                        ...
                        "esse é um banner de uma marca tradicional"} width={items[0].desktop?.Width} height={items[0].desktop?.Height} fetchPriority="low" class="object-cover lg:rounded-[40px] rounded-[20px] w-full"/>
                    </a>
                  ...
                  <div id={id} class="grid grid-rows-1">
                    <div class="col-start-1 col-span-3 row-start-1 row-span-1">
                      <Slider class="carousel carousel-center w-full gap-[0.5rem] px-5 leading-[1]">
                        {items.map((item, index) => (<Slider.Item index={index} class="carousel-item justify-start" key={index}>
                            ...
                            "esse é um banner de uma marca tradicional"} width={item.mobile?.Width} height={item.mobile?.Height} fetchPriority="low" class="object-cover rounded-[20px]"/>
                            </a>
                          </Slider.Item>))}
                      </Slider>
                    </div>
