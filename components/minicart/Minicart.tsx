...
export default function Cart({ cart: { platformCart, storefront: { items, total, subtotal, coupon, discounts, locale, shipping, currency, enableCoupon = true, freeShippingTarget, checkoutHref, }, }, }: {
    cart: Minicart;
}) {
    ...
    return (<>
      <form class="contents" id={MINICART_FORM_ID} hx-sync="this:replace" hx-trigger="submit, change delay:300ms" hx-target="this" hx-indicator="this" hx-disabled-elt="this" hx-post={useComponent(import.meta.url)} hx-swap="outerHTML">
        ...
        <div class={clx("flex flex-col flex-grow items-center overflow-hidden w-full", "[.htmx-request_&]:pointer-events-none [.htmx-request_&]:opacity-60 [.htmx-request_&]:cursor-wait transition-opacity duration-300")}>
          {/* Cart header */}
          ...
          {count === 0
            ? (<div class="flex flex-col m-auto gap-5">
                ...
                <label for={MINICART_DRAWER_ID} class="bg-[#1BAE32] py-[15px] w-full rounded-full text-white px-4 cursor-pointer">
                  Clique aqui e <b>veja os produtos</b> {">"}
                </label>
              </div>)
            : (<>
                <ul role="list" class="mt-[10px] px-2 flex-grow overflow-y-auto flex flex-col gap-6 w-full">
                ...
                <footer class="w-full bg-white">
                  ...
                  <div class="flex flex-col">
                    ...
                    {shipping !== null && (<div class="flex justify-between items-center pb-[10px] pt-5 px-4">
                  ...
                  <div class=" flex flex-col justify-end items-end gap-2 mx-4 pb-1">
                    <div class="flex justify-between items-center w-full">
                      ...
                      <output form={MINICART_FORM_ID} class="font-semibold text-xl">
                  ...
                  <div class="p-4">
                    <a class="bg-[#1BAE32] w-full no-animation flex items-center justify-center py-[10px] w-full rounded-full" href={checkoutHref} hx-on:click={useScript(sendBeginCheckoutEvent)}>
                    ...
                    <label for={MINICART_DRAWER_ID} class="flex w-full justify-center mt-5 text-[#123ADD] text-base">
