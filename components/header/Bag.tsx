  ...
  return (
    <>
      <label class="indicator" for={MINICART_DRAWER_ID} aria-label="open cart">
        <span
          id={id}
          class={`text-sm font-bold hidden indicator-item badge badge-primary badge-sm font-thin [.is-scrolled_&]:bg-white [.is-scrolled_&]:border-white [.is-scrolled_&]:text-primary`}
        />
