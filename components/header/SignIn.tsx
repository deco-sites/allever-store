...
function SignIn({ variant }: {
    ...
    const id = useId();
    return (<div id={id}>
      <a class={clx("p-0 font-thin  no-animation", variant === "mobile" && "")} href="/login" aria-label="Login">
        <Icon id="account_circle"/>
      </a>
      <a class={clx("hidden", "p-0 font-thin  no-animation", variant === "mobile" && "")} href="/account" aria-label="Account">
        <Icon id="account_circle"/>
