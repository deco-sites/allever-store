...
function Banner(props: SectionProps<ReturnType<typeof loader>>) {
    ...
    return (<div class="grid grid-cols-1 grid-rows-1">
      <Picture preload class="col-start-1 col-span-1 row-start-1 row-span-1">
        <Source src={image.mobile} width={360} height={120} media="(max-width: 767px)" loading="lazy"/>
        <Source src={image.desktop} width={1440} height={200} media="(min-width: 767px)" loading="lazy"/>
